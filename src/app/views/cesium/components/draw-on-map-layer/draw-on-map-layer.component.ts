...
import {AcLabelComponent} from 'angular-cesium';
import {AcHtmlComponent} from 'angular-cesium';
import {AcArcComponent} from 'angular-cesium';

@Component({
    selector: 'anms-draw-on-map-layer',
